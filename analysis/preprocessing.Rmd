...
#   select(article_id, sample_id, exclusion_reason_primary, exclusion_reason_secondary)
```
...
letters <- c("Letter", "Letters", "Letter to the editor", "Letters to the editor", "letters to the editor", "Letters to the Editor.", "letters to the editors", "Letters to the Editors", "Letters to the Editor", "Letter to the Editor")
# web_comments <- c()
...
d_journals <- d_journals %>%
  ...
  select(sample_id, journal_name, is_empirical, has_ppc, ppc_type = PPC_type, ppc_name = name_harmonized, ppc_description = description, ppc_length = length_harmonized, ppc_time = time_harmonized, ppc_ref = ref_harmonized, ppc_review = review_harmonized, cope, field, jif)
```
