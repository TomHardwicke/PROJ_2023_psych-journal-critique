...
wos_esci <- read_csv(here('data','prepareSample','journals','01 - fromWOS','wos-core-ESCI-2023-February-22.csv')) # load list of WOS journals
wos_scie <- read_csv(here('data','prepareSample','journals','01 - fromWOS','wos-core-SCIE-2023-February-22.csv')) # load list of WOS journals
wos_ssci <- read_csv(here('data','prepareSample','journals','01 - fromWOS','wos-core-SSCI-2023-February-22.csv')) # load list of WOS journals
wos_ahci <- read_csv(here('data','prepareSample','journals','01 - fromWOS','wos-core-AHCI-2023-February-22.csv')) # load list of WOS journals
