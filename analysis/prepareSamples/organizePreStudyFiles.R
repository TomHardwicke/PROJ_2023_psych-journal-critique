...
wos_esci <- read_csv(here('data','primary','prepareSample','01 - fromWOS','wos-core_ESCI 2023-February-22.csv')) # load list of all WOS journals
wos_scie <- read_csv(here('data','primary','prepareSample','01 - fromWOS','wos-core_SCIE 2023-February-22.csv')) # load list of all WOS journals
wos_ssci <- read_csv(here('data','primary','prepareSample','01 - fromWOS','wos-core_SSCI 2023-February-22.csv')) # load list of all WOS journals
wos_ahci <- read_csv(here('data','primary','prepareSample','01 - fromWOS','wos-core_AHCI 2023-February-22.csv')) # load list of all WOS journals
...
write_csv(wos_psych,here('data','primary','prepareSample','02 - modified','wos-psych.csv')) # save file

# this code loads the list of (the top 600) psychology journals included in Journal Citation Reports
wos_psych_jcr <- read_csv(here('data','primary','prepareSample','01 - fromWOS','wos-jcr-psych-2023.csv')) # load list of the top 600 ranked psychology journals in JCR
...
write_csv(wos_psych_jcr,here('data','primary','prepareSample','02 - modified','jcr-psych.csv')) # save file