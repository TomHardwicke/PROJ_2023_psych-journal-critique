...
d_journals_final_eligible <- d_journals_final_eligible %>% 
  mutate(review_harmonized = case_when(
           review_harmonized == "NO, This correspondence is published at the discretion of the Editor-in-Chief and the Associate Editors" ~ "NO",
           review_harmonized == "NOT STATED, The guidelines discuss peer review, but it appears that this discussion isn't relevant to commentary articles." ~ "NOT STATED",
           review_harmonized == "UNCLEAR (provide detail in the 'other' section below), It 'may' be sent for independent review: 'Matters Arising submissions that meet the journal’s criteria are sent to the authors of the original paper for a formal response. The comments and formal response may then be sent to independent referees.'" ~ "YES",
           TRUE ~ review_harmonized
         )) 
```
...
# Journals data — add JIF and COPE

## Identify JIFs for journals

For the random journals we can find the JIFs in the prominent journal sample. Some journals do not have a JIF because they haven't been indexed long enough. We manually checked all of these journals. One JIF needed to be added manually for the journal "Journal of Psychology and Theology". The 2021 JIF for this journal is .80.
