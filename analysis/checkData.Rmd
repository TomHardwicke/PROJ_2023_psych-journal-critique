...
```{r}
d_articles %>%
  count(exclusion_primary, exclusion_secondary)
```

Random ID 37 — TEH decides to go with primary coder and retain.
Random ID 41 - TEH decides to go with primary coder and retain.
Random ID 68 - TEH decides to go with secondary coder and exclude.
Random ID 95 - TEH decides to go with secondary coder and retain.
Random ID 103 — TEH decides to go with primary coder and exclude.
Random ID 120 — TEH decides to go with primary coder and retain.
