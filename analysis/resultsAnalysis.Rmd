...
# FIGURES
*Note.* These figures are not included in the final article as they do not offer additional informative informative beyond what was reported in the tables.
...
quantLength %>%  
 ...
 geom_jitter(width = 0.3,
             alpha = 0.8,
             size = 2) + 
 scale_color_manual(values = c("prominent" =  "#ff6347", 
                              "random" =   "#8db600",
                              "both" = "#000080")
                    ) +
 coord_flip() +
 ...
 labs(title = "All stated quantitative length limits", 
      x = "Post-publication critique type", 
      y = "Length limits (words)", 
      colour = "Sample")

ggsave("lengthLimits.png", plot = last_plot(), device = "png")
```
...
quantTime %>%  
 ...
 theme_bw() +
 theme(axis.text.y = element_text(angle = 90, hjust = 0.5)) +
 labs(title = "All stated quantitative time limits", 
      x = "Post-publication critique type", 
      y = "Time limits (weeks)", 
      colour = "Sample")

ggsave("timeLimits.png", plot = last_plot(), device = "png")
```
